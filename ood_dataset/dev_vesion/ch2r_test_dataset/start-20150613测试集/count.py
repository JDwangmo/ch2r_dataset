...
print('='*30)
print '统计start-20150613测试集的数据'
print('='*30)
print 'start running!'
logging.debug('='*30)
logging.debug('统计start-20150613测试集的数据')
logging.debug('='*30)
...
# ------------------------------------------------------------------------------
logging.debug('=' * 20)
logging.debug('文件路径设置')



log_data_file_path = '/home/jdwang/PycharmProjects/corprocessor/coprocessor/Corpus/ood_dataset/start-20150613测试集/output/dialogue_usersentence_ge_1.csv'

aiml_usersentence_file_path = '/home/jdwang/PycharmProjects/corprocessor/coprocessor/Corpus/ood_dataset/start-20150613测试集/output/aiml_usersentence.csv'
